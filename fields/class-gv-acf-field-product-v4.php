...
class gv_acf_field_product extends acf_field {
	...
	*/
	...
	function __construct( $settings )
	{
		// vars
		$this->name = 'product';
		$this->label = __('Product');
		$this->category = __("Basic",'prod'); // Basic, Content, Choice, etc
		$this->defaults = array(
...
<tr class="field_option field_option_<?php echo $this->name; ?>">
	<td class="label">
		<label><?php _e("Preview Size",'prod'); ?></label>
		<p class="description"><?php _e("Thumbnail is advised",'prod'); ?></p>
	</td>
	<td>
		<?php
		...
		do_action('acf/create_field', array(
			...
			'layout'	=>	'horizontal',
			'choices'	=>	array(
				'thumbnail' => __('Thumbnail', 'prod'),
				'something_else' => __('Something Else', 'prod'),
			)
		));
